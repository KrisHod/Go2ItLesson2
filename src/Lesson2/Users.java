...
public enum Users {
    ADMIN("all the permissions"), CUSTOMER_SERVICE("specific permission"), ANALYST("view and buy permissions"), CUSTOMER("reports permissions");
...
class Test {
    public static void main(String[] args) {
        ...
        if (adminCredentials[0].equals(args[0]) && adminCredentials[1].equals(args[1])) {
            ...
            System.out.println("Welcome, " + args[0] + "! Your group is " + Users.CUSTOMER_SERVICE + " and you have " + Users.CUSTOMER_SERVICE.getPermission());
